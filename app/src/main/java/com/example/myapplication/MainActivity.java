...
/*Ejemplo mutacion
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow,R.id.listRoutineFragment,R.id.rootRoutineFragment, R.id.sessionFragment)/////los que esten aqui tendra tendran el boton para ver el navigation viewer
